    ...
    try{
        ...
        const response = await ai.models.generateContent({
            ...
            config:{
                ...
                - Provide your response as a JSON object with two keys: 'text' for explanations and 'code' for code snippets. 
                    Example:

                        {  
                        "text": "This is a Python loop example.",  
...
module.exports ={ giveResponse , getAudio}